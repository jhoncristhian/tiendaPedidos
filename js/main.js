...
function actualizarCarritoUI(){
    fetch('http://localhost/CarritoDeCompras/api/carrito/api-carrito.php?action=mostrar')
    .then(response =>{
    ...
    .then(data =>{
        ...
        //aumentando
        html += `<a id='bconfirmar' href='./confirmarPedido.php'>Confirmar Pedido</a>`;
...
const addItemToCarrito = id =>{
    fetch('http://localhost/CarritoDeCompras/api/carrito/api-carrito.php?action=add&id=' + id)
    .then(response =>{
...
const removeItemFromCarrito = id =>{
    fetch('http://localhost/CarritoDeCompras/api/carrito/api-carrito.php?action=remove&id=' + id)
    .then(res =>{
        return res.json();
    })
    .then(data =>{
